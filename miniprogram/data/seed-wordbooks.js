const { IT_ENGLISH_1700_WORD_BOOK } = require('./it-english-1700');

function createWordBook(meta, words) {
  return {
    id: meta.id,
    name: meta.name,
    exam: meta.exam,
...
const SEED_WORDBOOKS = [
  createWordBook({
    ...
    { word: 'resource', translation: '资源', phonetic: '/ˈriːsɔːrs/', partOfSpeech: 'n.', example: 'Time is your most valuable learning resource.', mnemonic: '可以利用的来源。' },
  ...
  createWordBook({
    ...
    { word: 'feedback', translation: '反馈', phonetic: '/ˈfiːdbæk/', partOfSpeech: 'n.', example: 'User feedback helps improve the app.', mnemonic: '喂回来的信息流。' },
    ...
    { word: 'preview', translation: '预览', phonetic: '/ˈpriːvjuː/', partOfSpeech: 'n./v.', example: 'Preview the imported words before saving.', mnemonic: '提前看一看。' },
  ...
  IT_ENGLISH_1700_WORD_BOOK
];

module.exports = {
  SEED_WORDBOOKS: SEED_WORDBOOKS
};
